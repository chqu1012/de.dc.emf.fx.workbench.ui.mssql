 ...
 * @generated
 */
public class MssqlSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case MssqlPackage.MSSQL_MANAGER: {
			MssqlManager mssqlManager = (MssqlManager) theEObject;
			T result = caseMssqlManager(mssqlManager);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case MssqlPackage.MSSQL_SERVER: {
			MssqlServer mssqlServer = (MssqlServer) theEObject;
			T result = caseMssqlServer(mssqlServer);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseMssqlManager(MssqlManager object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseMssqlServer(MssqlServer object) {
		return null;
	}
