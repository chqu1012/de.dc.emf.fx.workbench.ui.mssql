 ...
 * </p>
 * <ul>
 *   <li>{@link de.dc.emf.fx.workbench.ui.mssql.impl.BoundImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BoundImpl extends MinimalEObjectImpl.Container implements Bound {
	...
	protected EClass eStaticClass() {
		return MssqlPackage.Literals.BOUND;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MssqlPackage.BOUND__VALUE, oldValue, value));
	}
