 ...
 * </p>
 * <ul>
 *   <li>{@link de.dc.emf.fx.workbench.ui.mssql.impl.PrimaryKeyImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimaryKeyImpl extends MinimalEObjectImpl.Container implements PrimaryKey {
	...
	protected EClass eStaticClass() {
		return MssqlPackage.Literals.PRIMARY_KEY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MssqlPackage.PRIMARY_KEY__NAME, oldName, name));
	}
