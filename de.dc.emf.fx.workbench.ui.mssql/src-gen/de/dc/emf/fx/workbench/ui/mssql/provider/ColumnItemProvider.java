...
/**
 * This is the item provider adapter for a {@link de.dc.emf.fx.workbench.ui.mssql.Column} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ColumnItemProvider extends ItemProviderAdapter
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Column_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Column_name_feature", "_UI_Column_type"),
						MssqlPackage.Literals.COLUMN__NAME, true, false, false,
	...
	protected void addDatatypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Column_datatype_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Column_datatype_feature",
								"_UI_Column_type"),
						MssqlPackage.Literals.COLUMN__DATATYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addSqlTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Column_sqlType_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Column_sqlType_feature",
								"_UI_Column_type"),
						MssqlPackage.Literals.COLUMN__SQL_TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Column_isNullable_feature",
								"_UI_Column_type"),
						MssqlPackage.Literals.COLUMN__IS_NULLABLE, true, false, false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MssqlPackage.Literals.COLUMN__PRIMARY_KEY,
				MssqlFactory.eINSTANCE.createPrimaryKey()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return MssqlEditPlugin.INSTANCE;
	}
