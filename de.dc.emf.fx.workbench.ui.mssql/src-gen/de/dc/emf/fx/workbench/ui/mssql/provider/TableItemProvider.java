...
/**
 * This is the item provider adapter for a {@link de.dc.emf.fx.workbench.ui.mssql.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider extends ItemProviderAdapter
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Table_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Table_name_feature", "_UI_Table_type"),
						MssqlPackage.Literals.TABLE__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MssqlPackage.Literals.TABLE__COLUMNS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case MssqlPackage.TABLE__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case MssqlPackage.TABLE__COLUMNS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(MssqlPackage.Literals.TABLE__COLUMNS, MssqlFactory.eINSTANCE.createColumn()));
	}
