...
/**
 * This is the action bar contributor for the Mssql model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MssqlActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	/**
	 * Action to create objects from the Mssql model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			MssqlModelWizard wizard = new MssqlModelWizard();
	...
	protected IAction showPropertiesViewAction = new Action(
			MssqlEditPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			MssqlEditPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		...
		toolBarManager.add(new Separator("mssql-settings"));
		toolBarManager.add(new Separator("mssql-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(MssqlEditPlugin.INSTANCE.getString("_UI_MssqlEditor_menu"),
				"de.dc.emf.fx.workbench.ui.mssqlMenuID");
		...
		//
		createChildMenuManager = new MenuManager(MssqlEditPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(MssqlEditPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(MssqlEditPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildSubmenuActions, null);
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(MssqlEditPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
